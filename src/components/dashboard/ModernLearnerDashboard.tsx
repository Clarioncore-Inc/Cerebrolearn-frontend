...
export function ModernLearnerDashboard({ onNavigate }: ModernLearnerDashboardProps) {
  ...
  // Learning stats
  const stats = [
    { label: 'Courses Enrolled', value: '12', icon: BookOpen, color: 'bg-blue-100 text-blue-600' },
    { label: 'Courses Completed', value: '5', icon: CheckCircle2, color: 'bg-green-100 text-green-600' },
    { label: 'Learning Hours', value: '148', icon: Clock, color: 'bg-purple-100 text-purple-600' },
    { label: 'Certificates Earned', value: '5', icon: Trophy, color: 'bg-yellow-100 text-yellow-600' },
  ];
        ...
        <TabsContent value="overview" className="mt-6 space-y-6">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" onClick={() => onNavigate?.('catalog')} className="gap-2">
