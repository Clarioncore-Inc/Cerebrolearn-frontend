          ...
          >
            <CardContent className='p-6'>
              <div className='flex items-start justify-between mb-4'>
                <div
                  className={`h-14 w-14 rounded-2xl bg-gradient-to-br ${stat.gradient} flex items-center justify-center group-hover:scale-110 transition-transform`}
                >
        ...
        <div className='grid gap-4 md:grid-cols-3'>
          {dailyChallenges.map((challenge) => (
            ...
            >
              ...
              <CardContent className='p-6'>
                <div
                  className={`h-12 w-12 rounded-xl bg-gradient-to-br ${challenge.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex items-center justify-between pt-2'>
                    ...
                    >
                      <Zap className='h-3 h-3 mr-1' />+{challenge.reward} XP
                    </Badge>
        ...
        {courses.length > 0 ? (
          <div className='grid gap-6 md:grid-cols-2 lg:grid-cols-3'>
            {courses.map((course, index) => {
              ...
              return (
                <div
                  key={course.id}
                  className='basis-0 content-stretch flex flex-col gap-[20px] grow items-start min-h-px min-w-[300px] relative shrink-0 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-300 cursor-pointer group'
                  ...
                  <div className='content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full px-6 pb-6'>
                    ...
                    <div className='content-center flex flex-wrap gap-[43px] items-center justify-between relative shrink-0 w-full'>
                      <div className='content-stretch flex gap-[10px] items-center justify-center relative shrink-0'>
                        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic relative shrink-0 text-[#101828] text-[18px]">
                          {course.title}
                        </p>
                      </div>
                    ...
                    <div className='content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full'>
                      <p className="font-['Lato:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#475467] text-[16px] w-full line-clamp-2">
                        {course.description ||
                          'orem ipsum dolor sit amet, consectetur adipis cing elit, sed do eiusmod tempor ...'}
                      </p>
                    </div>
                    ...
                    <div className='content-stretch flex flex-col gap-[8px] items-end relative shrink-0 w-full'>
                      ...
                      <div className='h-[8px] relative rounded-lg shrink-0 w-full'>
                        ...
                        <div
                          className='absolute bg-primary h-[8px] left-0 rounded top-0 transition-all duration-300'
          ...
          <Card className='p-12 text-center hover-lift border-2 shadow-none hover:shadow-md transition-all'>
            ...
            <p className='text-muted-foreground mb-6 max-w-md mx-auto'>
              Explore our course catalog and enroll in courses to begin
