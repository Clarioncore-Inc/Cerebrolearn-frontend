  ...
  const sampleCourses = [
    {
      ...
      description: "Learn Python from scratch with interactive exercises and real-world projects. Perfect for beginners!",
          ...
          content: {
            steps: [
              ...
              },
              {
                ...
                description: "Create a variable called 'age' and set it to your age",
                interactive: true,
    ...
    },
    {
      ...
      description: "Build a strong mathematical foundation for understanding machine learning algorithms.",
    ...
    },
    {
      ...
      description: "Learn SEO, content marketing, and social media strategies to grow your business.",
      category: "business",
      level: "beginner",
      public: true,
      lessons: [
    ...
    try {
      ...
      for (const courseData of sampleCourses) {
        try {
          ...
          const courseResult = await apiCall('/courses', {
            method: 'POST',
          ...
          // Publish the course
          await apiCall(`/courses/${courseResult.course.id}`, {
            method: 'PUT',
      ...
      toast.success(`Successfully created ${successCount} courses with lessons!`);
    } catch (error) {
    ...
    <Card className="max-w-md mx-auto">
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-muted-foreground">
          Populate the platform with sample courses and lessons to get started quickly.
        </p>
